    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-500" >
     <p className="mb-3 pt-3 text-xl"> Password Generator</p>
      ...
      <div>
        ...
        <input className="px-1 py-1 mx-2 cursor-pointer  " type="checkbox" defaultChecked={numberallow} onChange={ ()=>{
          setnumber((prev) => !prev )
        ...
        <input type="checkbox cursor-pointer  " className="px-1 py-1 mx-2" type="checkbox" 
        onChange={ ()=>{
          setchar((prev)=>!prev)
